...
sudo apxs -cia /var/www/conrad/puphpet/files/dot/mod_xsendfile.c
...
sudo sed -i "s/## XSEND/XSendFile On \\r\\n XSendFilePath \/var\/www\/conrad\/files/" /etc/httpd/conf.d/25-av_nvjebw8jor9g.conf
...
# Add 'www-user' and 'www-data' to 'vagrant' group
